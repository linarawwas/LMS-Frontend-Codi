...
const ClassSection = () => {
  ...
  const apiURLJoin = "https://lms-backend-codi-production.up.railway.app/api/join";
  ...
  const addClass = async () => {
    try {
      ...
      await axios.post(
        `https://lms-backend-codi-production.up.railway.app/api/classsections/`,
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            try {
              ...
              console.log(id);
              await axios.delete(
                `https://lms-backend-codi-production.up.railway.app/api/classsections/${id}`,
                {
                  headers: {
                    Authorization: `Bearer ${token}`,
                  },
